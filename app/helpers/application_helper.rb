module ApplicationHelper
  ...
  def get_notification_type_group_array(event)
    ...
    destination_based = {'event_highlights' => ['Event Highlight', 'Event Highlight'], 'quizzes' => ['Quiz', 'Quiz'], 'qnas' => ['Q&A', 'Q&A'], 'speakers' => ['Speaker', 'Speaker'], 'invitees' => ['Invitee', 'Invitee'], 'my_profile' => ['My Profile', 'Profile'], 'feedbacks' => ['Feedback', 'Feedback'], 'agendas' => ['Agenda', 'Agenda'], 'polls' => ['Poll', 'Poll'], 'leaderboard' => ['Leaderboard', 'Leaderboard'], 'faqs' => ['FAQ', 'FAQ'], 'abouts' => ['About', 'About'], 'conversations' => ['Conversation', 'Conversation'], 'e_kits' => ['E-Kit', 'E-Kit'], 'awards' => ['Award', 'Award'], 'contacts' => ['Contact', 'Contact'], 'sponsors' => ['Sponsors', 'Sponsors'], 'galleries' => ['Gallery', 'Gallery'], 'emergency_exits' => ['Emergency Exit', 'Emergency Exit'], 'exhibitors' => ['Exhibitor', 'Exhibitor'], 'my_travels' => ['My Travel', 'My Travel'], 'notes' => ['Note', 'Note'], 'venue' => ['Venue', 'Venue'], 'custom_page1s' => ['Custom Page1', 'Custom Page1'], 'custom_page2s' => ['Custom Page2', 'Custom Page2'], 'custom_page3s' => ['Custom Page3', 'Custom Page3'], 'custom_page4s' => ['Custom Page4', 'Custom Page4'], 'custom_page5s' => ['Custom Page5', 'Custom Page5'], 'qr_code' => ['QR code', 'QR code'], 'favourites' => ['My Favorite', 'My Favorite']}
    # all_arr = []
    # action_arr = []
    # logic_arr = []
    dest_arr = []
