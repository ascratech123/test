   ...
   $.fn.allcppanel = function(options) {
      ...
      var methods = {
         ...
         createMobileControls: function(options) {
            ...
            var controls = panels.find('');

            var arr = {};

            $.each(controls, function(i, e) {
               var This = $(e);
               var ID = $(e).parents('').attr('id');

               var controlW = This.width();
               var titleW = This.siblings('').width();
               var headingW = This.parent('').width();
         ...
         createControls: function(options) {
         	...
         	// List panel controls
            var panelControls = '<span class=""></span>';
