...
var demoHighCharts = function () {
    ...
    var highColors = [bgInfo, bgPrimary, bgSuccess, bgWarning,
        bgDanger, bgSuccessD, bgSystem, bgDark, bgAlert, bgone_on_one_chat, bggroup_chat
    ];
        ...
        var demoHighAreas = function () {
            ...
            if (area2.length) {
                ...
                $('#high-area2').highcharts({
                    colors: [bgSuccess, bgPrimary, bgAlert],
                    credits: false,
                    chart: {
                        type: 'area',
                        spacing: 0
                    ...
                    series: [{
                        id: 0,
                        name: 'Google',
                        data: [0, 0, 25, 28, 23, 28, 35, 40, 50, 30, 10, 0]
                    }, {
                        id: 1,
                        name: 'Bing',
                        data: [0, 0, 0, 0, 0, 25, 23, 32, 18, 18, 10, 5, 0]
                    }, {
                        id: 2,
                        name: 'Twitter',
                        data: [0, 30, 20, 15, 10, 5, 0]
                    }]
                });
            }
        };
