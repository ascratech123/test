class Analytic < ActiveRecord::Base
  ...
  ACTION_POINTS = {"favorite" => 5, "rated" => 5, "comment" => 2, "conversation post" => 5, "like" => 2, "quiz correct answer" => 5, "quiz incorrect answer" => 2, "question asked" => 5, "poll answered" => 5, "feedback given" => 10, 'e_kits' => 5, 'Login' => 10, 'profile_pic' => 5, 'page view' => 5, "played" => 5, 'Add To Calender' => 10, 'one_on_one' => 0, 'group chat' => 0}
  ...
  def update_points
    ...
    if feature.present?
      if error.exclude? false and ((self.points.blank? or (self.points.present? and self.points == 0)) and ["favorite", "rated", "comment", "conversation post", "like", "question asked", "played", "poll answered", "feedback given", 'profile_pic', 'Login', 'Add To Calender'].include? self.action or (self.viewable_type == 'E-Kit' and self.viewable_id.present?))
  ...
  def update_points_to_invitee
    ...
    if feature.present? and self.points > 0
      if self.invitee_id.present? and (["favorite", "rated", "comment", "conversation post", "like", "played", "question asked", "poll answered", "feedback given", 'profile_pic', 'Login', 'Add To Calender'].include? self.action or (self.viewable_type == 'E-Kit' and self.viewable_id.present?) )
