class Api::V1::TokensController < ApplicationController
  ...
  def get_key
    ...
    elsif not @user.encrypted_password == BCrypt::Engine.hash_secret(@password, @user.salt)
