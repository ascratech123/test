class UserFeedback < ActiveRecord::Base
  ...
  def Timestamp
    ...
    (feedback.created_at + feedback.event_timezone_offset.to_i.seconds).strftime("%d/%m/%Y %T")
  end
  ...
  def Timestamp
    ...
    (self.created_at + self.feedback.event_timezone_offset.to_i.seconds).strftime("%d/%m/%Y %T")
  end
