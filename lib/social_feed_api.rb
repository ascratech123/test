...
class SocialFeedApi
	...
	def self.get_facebook_posts(facebook_tags)
		...
		# end
			facebook_data = HTTParty.get("https://graph.facebook.com/#{facebook_tags}/posts?access_token=EAAJLHgicUhoBAJIjRFmhAX4Kfskd1rhgisjpCMi5mXZA7vP0ndpFl8KZCGH5BI9a12VbgsVAEwbnHVQ2bXZCrcGWcLZA3SJ4x1ub2OdZB5qE4G2MPHOOZAHmLxtNHxmzaer1L8NENOmepiAZBTVViaexYQbpU73EdPaB7Oisqk9UQZDZD&limit=20") rescue ""
	end	
