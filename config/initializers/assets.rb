...
Rails.application.config.assets.precompile += %w(theme_color_pick.js custom_page.js external_login.js external_login.css user_registration.js user_registration.css llqrcode.js webqr.js scanner.js scanner.css qr_code_scanner.js ckeditor/filebrowser/images/gal_del.png css/edm_time.css)
