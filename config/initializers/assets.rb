...
Rails.application.config.assets.precompile += %w(css/bootstrap.min.css css/blueimp-gallery.min.css css/jquery.fileupload.css css/jquery.fileupload-ui.css creategroup.css)
...
Rails.application.config.assets.precompile += %w(theme_color_pick.js custom_page.js external_login.js external_login.css user_registration.js user_registration.css llqrcode.js webqr.js scanner.js scanner.css qr_code_scanner.js rwd-table.js bootstrap.js bootstrap.min.css rwd-table.min.css  ckeditor/filebrowser/images/gal_del.png css/edm_time.css)
