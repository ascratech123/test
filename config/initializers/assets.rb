...
Rails.application.config.assets.precompile += %w( autocomplete-rails.js css/invitee_search.css js/invitee_search.js css/edm_time.css edm_header_footer_color_display_hash.js)
