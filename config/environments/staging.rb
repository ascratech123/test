Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'shobiz.ascratech.com' }
...
Rails.application.config.middleware.use ExceptionNotification::Rack,
 ...
 :email => {
   ...
   :exception_recipients => %w{uday@ascratech.com sushil@ascratech.in gayatri@ascratech.com hemant.patil@ascratech.com chirag@ascratech.com}
 }
